# 🎮 PlayGames — Next-Gen Web & 3D Gaming Platform
...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.com/deploy/playgames)

---

### 📌 GitHub Repository Details
* **Repository Name**: `PlayGames`
* **Short Description** (72 / 75 chars):
  `Next.js 14 3D WebGL gaming platform with multi-screen, AI & admin tools.`
* **One-Click Deploy**: [https://railway.com/deploy/playgames](https://railway.com/deploy/playgames)

---

**PlayGames** is a state-of-the-art web-based gaming platform engineered with **Next.js 14 App Router**, **Three.js WebGL Engines**, **Prisma ORM**, and **Tailwind CSS**. It offers instant browser gaming without paywalls or annoying popups, packed with native 3D games, multi-screen play mode, an embedded AI Gaming Buddy, theme switching, developer submission portal, and a full-fledged Super Admin dashboard.
...
Follow these steps to set up and run **PlayGames** locally.
...
```bash
# Clone repository
git clone https://github.com/your-username/PlayGames.git
cd PlayGames
...
```env
DATABASE_URL="postgresql://postgres:postgres@localhost:5432/playgames?schema=public"
JWT_SECRET="super-secret-playgames-jwt-token-key-2026-secure"
NEXT_PUBLIC_APP_URL="http://localhost:3000"

# Customizable Admin Credentials
ADMIN_EMAIL="admin@playgames.com"
...
| :--- | :--- | :--- | :--- |
| **Super Admin** | `admin@playgames.com` | `admin123` | Full access (`/admin`, Site Config, Game Moderation, User Roles) |
| **Developer** | `developer@playgames.com` | `dev123` | Developer access (`/developer`, Submit & Manage Games) |
...
docker build -t playgames-platform .
...
Click the button above or visit: **[https://railway.com/deploy/playgames](https://railway.com/deploy/playgames)**

1. Provision a **PostgreSQL** database plugin in Railway.
2. Add Environment Variables (`DATABASE_URL`, `JWT_SECRET`, `ADMIN_EMAIL`, `ADMIN_PASSWORD`).
3. Railway automatically detects `railway.json` and `Dockerfile` / `nixpacks.toml` to build and deploy.
